...
1. **No global equilibrium — statically impossible states read as safe.** A rigid body past its tipping point is *inexpressible* because the model only ever checks joints (§5.7). Behind the corbel ruling's cost and partially 10/19/20. (Case 12's pier was thought to sit here too, until the 2026-08-09 re-ruling worked the numbers — see §8.)

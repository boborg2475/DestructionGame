...
**Status: SLICES 1 THROUGH 4 ARE BUILT; 5 IS NOT.** [CURRENT_STATE.md](CURRENT_STATE.md) records where the code has got to; this file stays the authority on what it should do.
